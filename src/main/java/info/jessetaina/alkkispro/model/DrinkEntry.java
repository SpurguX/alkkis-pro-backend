...
public class DrinkEntry {
	...
	@NotNull private Date drink_date;
	
	@NotNull
	@ManyToOne(targetEntity = Juoma.class, optional = false)
	@JoinColumn
	private long juoma_id;
	
	
	@NotNull private int drink_quantity; 
	@NotNull private Double drink_entry_units;
	
	public DrinkEntry() {}
	
	public DrinkEntry(long drink__entry_id, @NotNull Date drink_date, @NotNull long drink_id,
			@NotNull int drink_quantity, @NotNull Double drink_entry_units) {
		super();
		this.drink_entry_id = drink__entry_id;
		this.drink_date = drink_date;
		this.juoma_id = drink_id;
		this.drink_quantity = drink_quantity;
		this.drink_entry_units = drink_entry_units;
	}
	public long getDrink__entry_id() {
		return drink_entry_id;
	}
	public void setDrink__entry_id(long drink__entry_id) {
		this.drink_entry_id = drink__entry_id;
	}
